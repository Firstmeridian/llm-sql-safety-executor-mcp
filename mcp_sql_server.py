...
if SKILLS_ENABLED:
    ...
    _discovered_skills = discover(
        ...
        load_mutations=SKILLS_ALLOW_MUTATIONS,
    )
    ...
    if SKILLS_ALLOW_MUTATIONS:
                ...
                "properties": {
                    ...
                    "execution_outcome": {
                        ...
                        "description": (
                            ...
                            "handling; for a managed mutation this field describes "
                            "the one framework-executed statement. Once an "
                            "imperative callback runs, its whole-operation "
                    ...
                    "error_code": {
                        "type": "string",
                        "description": (
                            "Extensible machine-readable failure code. Published meanings "
                            "are stable; unknown codes never authorize automatic retry."
                        ),
                    },
                    "error": {
                        "type": "string",
                    ...
                    "preview": {
                        ...
                        "additionalProperties": True,
                        "description": (
                            "Business context from the Skill. For managed mutations, "
                            "preview_sql and bound_params are generated by the framework "
                            "from the cached plan and final preview binding."
                        ),
                    },
                    "preview_token": {
                        "type": "string",
        ...
        async def execute_mutation_skill(
            ...
            try:
                ...
                mutation = (
                    load_mutation(skill_name, adapter, _audit_logger)
            ...
            if not resolved_confirm:
                ...
                if meta._managed_mutation_plan is None:
                    if mutation is None:
                        raise RuntimeError(
                            "Mutation framework did not instantiate the "
                            "imperative Skill."
                        )
                    try:
                        validation = mutation.validate(validated_params)
