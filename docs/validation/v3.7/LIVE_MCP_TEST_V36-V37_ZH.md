...
> Historical record: Skill names below reflect that release/test run. For current `sample-` names and configuration migration, see [the v3.7.2 migration guide](../../releases/RELEASE_NOTES_v3_7.md#sample-skill-names-and-local-files).
