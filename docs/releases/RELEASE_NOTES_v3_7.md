...
The design includes [migration and benefit/cost tables](../guides/V3_7_CONNECTION_DIAGNOSTICS_DESIGN.md#unified-contract-review-and-migration--september-22-2026).
...
the [September 22 staged verification record](../validation/v3.7/V3_7_3_LIVE_MCP_TEST_UNIFIED_CONNECTION_DIAGNOSTICS_2026_09_22_ZH.md).
...
above. See the [September 15 version decision and commit message](../guides/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md#13-v373-版本归属与提交说明).
...
server does not provide that mechanism; see the [deployment acceptance criteria](../guides/MCP_AGENT_BEHAVIOR_VALIDATION_ZH.md#18-限制优先级与配置解读的可复用验收).
...
have refreshed. See the [implementation and validation record](../guides/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md)
and [Agent trials](../validation/v3.7/V3_7_3_LIVE_MCP_TEST_CONNECTION_ROUTING_2026_09_13_ZH.md)
...
[native-Host review](../validation/v3.7/V3_7_3_LIVE_MCP_TEST_CONNECTION_ROUTING_2026_09_14_ZH.md).
...
[follow-up record](../guides/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md#8-用途目标未确定时暂停数据库操作2026-09-14).
...
See the [complete review and evidence](../validation/v3.7/V3_7_3_LIVE_MCP_TEST_CONNECTION_ROUTING_2026_09_15_ZH.md).

The subsequent [fixture boundary review](../validation/v3.7/V3_7_3_LIVE_MCP_TEST_CONNECTION_BOUNDARIES_2026_09_15_ZH.md)
...
[complete pending-change table](../guides/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md#11-本次待提交修改的完整范围)
...
The [design record](../guides/V3_7_CONNECTION_DIAGNOSTICS_DESIGN.md) documents why shared
...
A [Chinese edition](../guides/V3_7_CONNECTION_DIAGNOSTICS_DESIGN_ZH.md) is also available.
...
[`LIVE_MCP_TEST_V36-V37_ZH.md`](../validation/v3.7/LIVE_MCP_TEST_V36-V37_ZH.md).
