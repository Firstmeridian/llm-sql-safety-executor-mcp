> Historical v3.7 guide. Its script names and environment configuration apply to that version only. Use the [v3.8 client guide](TEST_MCP_CLIENT_GUIDE.md) for the current package.
...
[MCP Agent behavior validation method](MCP_AGENT_BEHAVIOR_VALIDATION_ZH.md).
...
- [README.md](../history/README_v3.7.md) - Complete project documentation
