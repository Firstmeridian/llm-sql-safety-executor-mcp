...
> **v3.8 对照入口（2026-09-26）：** 本文保留 v3.5–v3.7 的设计解释和迁移背景。旧环境变量、default-only 授权、根目录脚本及 SDK 导入不再适用于 v3.8；当前配置、权限和导入见[迁移指南](CONFIGURATION_ZH.md)，新增 MRTR 边界见[安全说明](../security/V3_8_SECURITY.md)。

> 本文是面向使用者、Skill 作者和代码审查者的说明，不替代
> [Skills 安全策略](../security/SAFETY.md)、[Skills 设计文档](../architecture/MCP_AGENTS_SKILLS_DESIGN.md)
> 或发布说明。
>
...
> 参数示例修正；现行规则和已知限制见
> [v3.7.3 发布说明](../releases/RELEASE_NOTES_v3_7.md#v373--connection-routing-and-tool-contract-clarity)，
> 没有改变本文的批准机制或单 mutation worker 部署边界。同一 v3.7.3 的
> [2026-09-16 受管契约补充](../releases/RELEASE_NOTES_v3_7.md#managed-single-statement-mutation-contract--september-16-2026)
...
> [Skills 安全策略](../security/SAFETY.md) 为准。
...
[真实 MCP 联调记录](../validation/v3.7/LIVE_MCP_TEST_V36-V37_ZH.md)：该批次在
...
- [v3.5 发布说明](../releases/RELEASE_NOTES_v3_5.md)
- [v3.6/v3.6.1 发布说明](../releases/RELEASE_NOTES_v3_6.md)
- [v3.7/v3.7.1 发布说明](../releases/RELEASE_NOTES_v3_7.md)
- [Skills 设计文档](../architecture/MCP_AGENTS_SKILLS_DESIGN.md)
- [Skills 安全策略](../security/SAFETY.md)
- [设计风险登记表](../security/DESIGN_RISK_REGISTER_ZH.md)
- [真实 MCP 联调记录](../validation/v3.7/LIVE_MCP_TEST_V36-V37_ZH.md)
