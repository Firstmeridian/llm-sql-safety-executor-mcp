> Historical Skill safety guidance. For v3.8 configuration, SDK imports and MRTR boundaries see [current security](V3_8_SECURITY.md) and [migration](../guides/CONFIGURATION_ZH.md).
