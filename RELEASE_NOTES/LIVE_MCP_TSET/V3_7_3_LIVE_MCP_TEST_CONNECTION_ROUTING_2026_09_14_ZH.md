...
[实施与验收方案](../GUIDE/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md)、
[可复用方法](../GUIDE/MCP_AGENT_BEHAVIOR_VALIDATION_ZH.md)、
[DRR](../../DESIGN_RISK_REGISTER_ZH.md)。
...
[用途目标未确定时暂停规则](../GUIDE/V3_7_3_CONNECTION_ROUTING_REMEDIATION_ZH.md#8-用途目标未确定时暂停数据库操作2026-09-14)：
...
[第 16 节方法](../GUIDE/MCP_AGENT_BEHAVIOR_VALIDATION_ZH.md#16-目标澄清规则补充修复的验收)
