...
- who: Agent identity (ctx.client_id or configured skills.audit.agent_id)
...
Design References:
- docs/security/SAFETY.md #10: Best-effort audit logging for mutation operations
...
class AuditLogger:
    ...
    Attributes:
        ...
        agent_id: Default agent identifier (an untrusted audit label).
    """

    def __init__(self, log_path: Path | str, agent_id: str = "unknown"):
        """
        Initialize the audit logger.

        Args:
            log_path: Path to the audit log file.
                      Resolved explicitly from skills.audit.path.
        """
